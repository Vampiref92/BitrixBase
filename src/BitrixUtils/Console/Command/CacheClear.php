...
class CacheClear extends Command implements LoggerAwareInterface
{
    ...
    {
        $this->setName('cache:clear')->setDescription('Clear cache')->addArgument(self::ARG_CACHE_TYPE,
            InputArgument::OPTIONAL, 'Cache type [all, menu, managed, html]', 'all')->addOption(self::OPT_CACHE_PATH,
            'path', InputOption::VALUE_OPTIONAL, 'Cache path', '');
    }
